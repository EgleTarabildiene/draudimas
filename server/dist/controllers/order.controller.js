...
class OrderController {
    static getAll(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < result.length; i++) {
                ...
                const [owners] = yield connect_1.pool.query(sql2, [result[i].id]);
    ...
    static insert(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            order.owners.forEach((owner) => __awaiter(this, void 0, void 0, function* () {
                const sql2 = "INSERT INTO orders_owners (order_id, owner_id, count) VALUES (?, ?, ?)";
                yield connect_1.pool.query(sql2, [insertId, owner.ownerId, owner.count]);
            }));
            res.status(201).json({
                "success": true
            });
